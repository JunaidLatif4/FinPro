											...
											<DialogContent>
												<div className='row g-3'>
													<div className='col-12 col-md-6 mb-3'>
														...
														<input type='text' name='plan' value={revenueForm.plan} onChange={handleRevenueChange} className='form-control' id='plan' placeholder='Plan Name' required />
													</div>
													<div className='col-12 col-md-6 mb-3'>
						...
						<tbody>
							{revenues &&
								...
								revenues.revenuInputs.map((rev, id) => (
									<tr key={id}>
										<td>{rev.plan}</td>
										<td>{user.currency || "$"}{parseInt(rev.price).toLocaleString()}.00</td>
